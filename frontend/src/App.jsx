...
import JobDetail from './pages/placement/JobDetail';
import InternshipDetail from './pages/placement/InternshipDetail';
import DriveDetail from './pages/placement/DriveDetail';
import WorkshopDetail from './pages/placement/WorkshopDetail';
import ConferenceDetail from './pages/placement/ConferenceDetail';
    ...
    <AuthProvider>
      ...
      <Routes>
        ...
        <Route path="/placement" element={<PlacementLayout />}>
          ...
          <Route path="campus-drives/:id" element={<DriveDetail />} />
